    ...
    <div className="p-8">
      <div className="flex justify-between">
        ...
        <div className="flex justify-around gap-10 mr-5">
          ...
          <Link to="/order" className="text-blue-500 underline my-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-scroll-text">
              <path d="M15 12h-5"/>
              <path d="M15 8h-5"/>
      ...
      {cartItems.length === 0 ? (
        <div className="text-center mt-10">
          <p className="text-lg font-semibold">Adicione algo ao carrinho</p>
        </div>
      ) : (
        <>
              ...
              <div key={item.id} className="border p-4 rounded-lg flex flex-direction-row">
                    ...
                    <div>
                      ...
                      <div className="flex gap-4 items-center mt-4">
                        ...
                        <p className='font-bold p-2 border rounded-lg text-[12px]'> R$ {(item.price * quantities[item.id]).toFixed(2)}</p>
                        <button
                  ...
                  <img className="rounded-lg w-40 ml-10" src={item.image_url} alt={item.name} />
